    ...
    updateSelectedRows() {
        ...
        if (currentlySelectedRows.length != previouslySelectedRows.length) {
            ...
            this.dataObj.forEach(record => {
                ...
                let recordChecked = currentlySelectedRows.includes(record.id) && !previouslySelectedRows.includes(record.id);
                let recordUnchecked = !currentlySelectedRows.includes(record.id) && previouslySelectedRows.includes(record.id);
